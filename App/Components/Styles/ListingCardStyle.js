...
export default connect({
  ...
  image: 'full h-131 bg-gray',
  commission: 'absolute z-10 bg-gold right-4 bottom-4 items-center justify-center rounded-lg px-4 py-0.5',
  comText: 'text-white regular text-xs',
  percent: 'text-white text-xl bold mt--1',
  ...
  title: 'regular text-base text-black mb-1 flex',
  private: 'rounded-full px-3 py-1 text-white demi bg-black text-xs',
